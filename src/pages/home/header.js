            ...
            <nav className="navbar navbar-expand-lg ">
                <div className="container-fluid ">
                    <a href="/" className="d-flex align-items-center text-dark text-decoration-none">
                        ...
                        <span className="fs-4">ChatGPT - 轻松版</span>
                    </a>
                    ...
                    <div className="collapse navbar-collapse justify-content-end mt-1" id="navbarNav">
                        <div className="navbar-nav">
                            <a className="me-3 py-2 text-dark text-decoration-none"
                               href="/accounts">账号购买</a>
                            <a className="me-3 py-2 text-dark text-decoration-none" href="/gpt">套餐购买</a>
                            <a className="me-3 py-2 text-dark text-decoration-none" href="/chat">聊天入口</a>
                            <a className="me-3 py-2 text-dark text-decoration-none"
                               href="/search">订单查询入口</a>
                            <a className="me-3 py-2 text-dark text-decoration-none" href="/use">使用说明</a>
                            <a className="me-3 py-2 text-dark text-decoration-none"
                               href="/copright">免责声明</a>
                        </div>
                    </div>
                </div>
            </nav>
