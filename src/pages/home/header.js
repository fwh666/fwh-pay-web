                ...
                <div className="container-fluid ">
                    ...
                    <div className="collapse navbar-collapse justify-content-end mt-1" id="navbarNav">
                        <div className="navbar-nav">
                            ...
                            {/*<a className="me-3 py-2 text-dark text-decoration-none" href="chat.html">聊天入口</a>*/}
                            {/*<a className="me-3 py-2 text-dark text-decoration-none" href="search.html">订单查询入口</a>*/}
                            {/*<a className="me-3 py-2 text-dark text-decoration-none" href="use.html">使用说明</a>*/}
                            {/*<a className="me-3 py-2 text-dark text-decoration-none" href="copright.html">免责声明</a>*/}
                        </div>
                    </div>
                </div>
            </nav>
